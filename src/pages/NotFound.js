    ...
    <div className="NotFound container mx-auto mt-4 px-4 container-1 pt-20 pb-12">
        <div className="flex flex-wrap ">
            <div className="image-container pr-4 pl-4 ">
                <img alt="" src={darkTheme ? notFoundDark : notFound } className="img-responsive max-w-full h-auto" />
            </div>
            <article className="py-8 px-4 mb-8 bg-gray-200 rounded pr-4 pl-4 text-container">
                ...
                <p className="text-xl font-light">Please bear with us as the page you requested could not be found.</p>
                <p>You can return to our <Link to="/" className="text-blue-200">home page</Link> or <Link to="/contact" className="text-blue-200">contact us</Link> for more info</p>
            </article>
        </div>
    </div>
    )
