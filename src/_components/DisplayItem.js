...
function DisplayItem(props) {
  ...
  if (!props.value) {
    return <h2 className="txt-black-white">Item Not Found!</h2>;
  }
        ...
        <section className="row">
          <div className="product-description-container">
            <article className="product-description">
              <header className="txt-gold-blue txt-700 mb-3">
                {props.value.category.toUpperCase()}
              </header>
              <h3 className="txt-black-white txt-700 mb-3" id="productName">
                {props.value.title}
              </h3>
              <p className="txt-gray-purple description">
            ...
            <div className="product-price-container">
              <div className="product-price mb-3">
                <div className="product-price-current">
                  <div>
                    <span className="product-price-value txt-black-white txt-700">
                      $<span id="currentPrice">{props.value.price}</span>
                    </span>
                  </div>
                  <div className="perc-off">
                    <span className="product-price-mark txt-gold-blue">
                      {percOff}%
                    </span>
                  </div>
                </div>
                <div className="product-price-original">
                  <div className="product-price-del">
                    <s className="product-price-value txt-gray-purple">
                      {(props.value.price / (1 - percOff / 100)).toFixed(2)}
                    </s>
                  </div>
                </div>
              </div>
