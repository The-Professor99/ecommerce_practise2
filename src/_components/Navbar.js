      ...
      >
        ...
        >
          <span className="navbar-toggler-icon-svg">
            <img
              src={props.darkTheme ? menuIconLight : menuIcon}
              width="14"
              height="15"
              alt="Show Menu"
            />
          ...
          <span className="close">
            <img
              src={props.darkTheme ? closeIconLight : closeIcon}
              width="16"
              height="15"
              alt="Close Menu"
            />
      ...
      <div className="container main-container1">
        <nav className="navbar navbar-expand-lg navbar-light mt-3">
          ...
          <Link className="navbar-brand" to="/">
            <img
              src={props.darkTheme ? logoLight : logo}
              width="140"
              height="20"
              alt="Logo"
            />
            ...
            <div className="dropdown">
              ...
              {!user ? (
                ...
                >
                  ...
                  <li className="dropdown-item" onClick={handleAuthentication}>
                    Logout
                  </li>
                </div>
              )}
